...
public class JeiText implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addIngredientInfo(new ItemStack(Items.end_bone.get()), VanillaTypes.ITEM_STACK, Component.translatable("moonstone.jei.item.moonstone.end_bone").append(Component.translatable("moonstone.jei.item.moonstone.nightmare_base.all").append(Component.translatable("item.moonstone.nightmare_base_stone"))));
