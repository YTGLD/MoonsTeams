...
public class SunRenderer  extends EntityRenderer<sun> {
    public SunRenderer(EntityRendererProvider.Context p_173917_) {
        super(p_173917_);
    }

    @Override
    public void render(sun entity, float p_114486_, float p_114487_, PoseStack poseStack, MultiBufferSource bufferSource, int p_114490_) {
        renderSphere1(poseStack,bufferSource,240,1f);
    ...
    @Override
    public ResourceLocation getTextureLocation(sun p_114482_) {
