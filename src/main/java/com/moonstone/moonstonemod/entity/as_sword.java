...
public class as_sword extends ThrowableItemProjectile {
    ...
    public void tick() {
            ...
            if (target != null) {
                if (this.tickCount > 30) {
                    ...
                    if (angle > 10) {
                        ...
                        this.setDeltaMovement(limitedDirection.x * 1.22f, limitedDirection.y * 1.22f, limitedDirection.z * 1.22f);
                    } else {
                        this.setDeltaMovement(direction.x * 1.22f, direction.y * 1.22f, direction.z * 1.22f);
                    }
                }
        ...
        if (!trailPositions.isEmpty()) {
            if (trailPositions.size() > 15||!canSee) {
