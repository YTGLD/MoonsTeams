...
public class AIgiant {
    ...
    private static final List<SensorType<? extends Sensor<? super com.moonstone.moonstonemod.entity.cell_giant>>> SENSOR_TYPES = List.of(SensorType.NEAREST_PLAYERS);
    ...
    private static final BehaviorControl<com.moonstone.moonstonemod.entity.cell_giant> DIG_COOLDOWN_SETTER = BehaviorBuilder.create((p_258953_) -> {
    ...
    public static Brain<?> makeBrain(com.moonstone.moonstonemod.entity.cell_giant p_219521_, Dynamic<?> p_219522_) {
        Brain.Provider<com.moonstone.moonstonemod.entity.cell_giant> provider = Brain.provider(MEMORY_TYPES, SENSOR_TYPES);
        Brain<com.moonstone.moonstonemod.entity.cell_giant> brain = provider.makeBrain(p_219522_);
    ...
    private static void initEmergeActivity(Brain<com.moonstone.moonstonemod.entity.cell_giant> p_219527_) {
