...
public class BoltRenderer extends EntityRenderer<bolt> {
    public BoltRenderer(EntityRendererProvider.Context p_174286_) {
        super(p_174286_);
    }
    ...
    public void render(bolt p_115266_, float p_115267_, float p_115268_, PoseStack p_115269_, MultiBufferSource p_115270_, int p_115271_) {
        ...
        p_115269_.mulPose(Axis.XP.rotation((float) p_115266_.getX()));
        p_115269_.mulPose(Axis.YP.rotation((float) p_115266_.getY()));
        p_115269_.mulPose(Axis.ZP.rotation((float) p_115266_.getZ()));
