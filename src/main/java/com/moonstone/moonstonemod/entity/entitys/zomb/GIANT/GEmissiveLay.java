package com.moonstone.moonstonemod.entity.entitys.zomb.GIANT;
...
public class GEmissiveLay <T extends cell_giant, M extends GModel<T>> extends RenderLayer<T, M> {
    ...
    @OnlyIn(Dist.CLIENT)
    public interface AlphaFunction<T extends cell_giant> {
        float apply(T p_234920_, float p_234921_, float p_234922_);
    }

    @OnlyIn(Dist.CLIENT)
    public interface DrawSelector<T extends cell_giant, M extends EntityModel<T>> {
