...
import com.moonstone.moonstonemod.entity.other.*;
...
public class EntityTs {
    ...
    public static final RegistryObject<EntityType<com.moonstone.moonstonemod.entity.other.cell_giant>> cell_giant = REGISTRY.register("cell_giant",
            ()-> EntityType.Builder.of(com.moonstone.moonstonemod.entity.other.cell_giant::new, MobCategory.MONSTER).sized(0.9F, 2.9F).clientTrackingRange(16).build("cell_giant"));
    ...
    public static void  EntityAttributeCreationEvent(EntityAttributeCreationEvent event){
        ...
        event.put(EntityTs.cell_giant.get(), com.moonstone.moonstonemod.entity.other.cell_giant.createAttributes().build());
