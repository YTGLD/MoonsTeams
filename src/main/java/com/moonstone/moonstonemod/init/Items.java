...
//    public static final RegistryObject<Item> light_amout =REGISTRY.register("light_amout", com.moonstone.moonstonemod.item.nanodoom.light_amout::new);
    ...
    public static final RegistryObject<Item> owner_blood_eye =REGISTRY.register("owner_blood_eye", BloodItem::new);

    public static final RegistryObject<Item> owner_blood_attack_eye =REGISTRY.register("owner_blood_attack_eye", BloodItem::new);
    public static final RegistryObject<Item> owner_blood_speed_eye =REGISTRY.register("owner_blood_speed_eye", BloodItem::new);

    public static final RegistryObject<Item> owner_blood_boom_eye =REGISTRY.register("owner_blood_boom_eye", BloodItem::new);
    public static final RegistryObject<Item> owner_blood_effect_eye =REGISTRY.register("owner_blood_effect_eye", BloodItem::new);
    public static final RegistryObject<Item> owner_blood_vex =REGISTRY.register("owner_blood_vex", BloodItem::new);
    public static final RegistryObject<Item> owner_blood_earth =REGISTRY.register("owner_blood_earth", BloodItem::new);
    ...
    public static final RegistryObject<Item> muscle_conversion =REGISTRY.register("muscle_conversion", com.moonstone.moonstonemod.item.man.muscle_conversion::new );
    public static final RegistryObject<Item> phosphate_bond =REGISTRY.register("phosphate_bond", com.moonstone.moonstonemod.item.man.phosphate_bond::new );
    public static final RegistryObject<Item> chemical_compound =REGISTRY.register("chemical_compound", com.moonstone.moonstonemod.item.man.chemical_compound::new );
    public static final RegistryObject<Item> white_blood_cells_are_abruptly_reduced =REGISTRY.register("white_blood_cells_are_abruptly_reduced", com.moonstone.moonstonemod.item.man.white_blood_cells_are_abruptly_reduced::new );
    public static final RegistryObject<Item> skin_glucose_fermentation =REGISTRY.register("skin_glucose_fermentation", com.moonstone.moonstonemod.item.man.skin_glucose_fermentation::new );
    ...
    public static final RegistryObject<Item> deceased_contract =REGISTRY.register("deceased_contract", deceased_contract::new );
