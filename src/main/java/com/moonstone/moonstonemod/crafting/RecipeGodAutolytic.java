...
public class RecipeGodAutolytic extends CustomRecipe {
    private final CraftingBookCategory category;

    public final Item in = Items.autolytic.get();
    public final Item out = Items.god_autolytic.get();

    public RecipeGodAutolytic(CraftingBookCategory category, ResourceLocation resourceLocation) {
    ...
    public @NotNull RecipeSerializer<?> getSerializer() {
        return AllCrafting.RecipeGodAutolytic.get();
    }
}
