...
public class RecipeGodPutrefactive  extends CustomRecipe {
    private final CraftingBookCategory category;

    public final Item in = Items.putrefactive.get();
    public final Item out = Items.god_putrefactive.get();

    public RecipeGodPutrefactive(CraftingBookCategory category, ResourceLocation resourceLocation) {
    ...
    public @NotNull RecipeSerializer<?> getSerializer() {
        return AllCrafting.RecipeGodPutrefactive.get();
    }
}
