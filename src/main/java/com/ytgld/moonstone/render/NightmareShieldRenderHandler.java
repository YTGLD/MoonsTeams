...
public class NightmareShieldRenderHandler {
        ...
        if (player != null && minecraft.level != null) {
            if (!player.isCreative() && !player.isSpectator()) {
                ...
                if (max > 0) {
                    if (aFloat < 1) {
                        ...
                        poseStack.translate(
                                ...
                                ((guiGraphics.guiHeight() - 47f) - (float) (s) / 2),0);
                        new MGuiGraphics.GUI(CIStateShardsHasBlack::getHasBlock,true).blit(guiGraphics
                                , ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                ...
                poseStack.translate(
                        ...
                        (guiGraphics.guiHeight() - 47f)- (float) (24) / 2,0);
                if (max > 0) {
                    float s = aFloat;
                    if (s < 0) {
                        s = 0;
                    ...
                    if (delta <= 0.25 && delta > 0.1f) {
                        renderSs4(guiGraphics, s, ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                                "textures/gui/nightmare_shield_4.png"),ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                                "textures/gui/nightmare_shield_glow_4.png"));
                    }else if (delta > 0.25 && delta <= 0.5) {
                        renderSs4(guiGraphics, s, ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                                "textures/gui/nightmare_shield_3.png"),ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                                "textures/gui/nightmare_shield_glow_3.png"));
                    }else if (delta > 0.5 && delta <= 0.75) {
                        renderSs4(guiGraphics, s, ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                                "textures/gui/nightmare_shield_2.png"),ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                                "textures/gui/nightmare_shield_glow_2.png"));
                    }else if (delta > 0.75 && delta <= 1) {
                        renderSs4(guiGraphics, s, ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
                                "textures/gui/nightmare_shield_1.png"), ResourceLocation.fromNamespaceAndPath(Moonstone.MODID,
    ...
    public static void renderSs4(GuiGraphics guiGraphics, float s, ResourceLocation resourceLocation, ResourceLocation glowRes){
        ...
        var player = minecraft.player;
        if (player != null) {
            new MGuiGraphics.GUI(CIStateShardsHasBlack::getHasBlock,false).blit(guiGraphics
