                ...
                for (int i = 0; i < stacksHandler.getSlots(); i++) {
                    ...
                    if (!stack.isEmpty()) {
                        if (stack.is(Items.medicinebox.get())) {
                            if (stack.get(DataReg.tag) != null && !stack.get(DataReg.tag).getBooleanOr(spawn,false)) {
                                if (Handler.hascurio(player, Items.medicinebox.get())) {
                        ...
                        if (!stack.isEmpty()) {
                            if (stack.is(Items.medicinebox.get())) {
                                ...
                                if (a.is(net.minecraft.world.item.Items.GOLDEN_APPLE)){
                                    ...
                                    if (stack.get(DataReg.tag)!= null&&stack.get(DataReg.tag).getIntOr(apple,0)< 9){
                                        stack.get(DataReg.tag).putInt(apple,stack.get(DataReg.tag).getIntOr(apple,0)+1);
                                    }
                                    if (stack.get(DataReg.tag)!= null&&stack.get(DataReg.tag).getIntOr(apple,0)== 8){
            ...
            CuriosApi.getCuriosInventory(player).ifPresent(handler -> {
                ...
                for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                    ...
                    for (int i = 0; i < stacksHandler.getSlots(); i++) {
                        ...
                        if (!stack.isEmpty()) {
                            if (stack.is(Items.medicinebox.get())) {
                                if (stack.get(DataReg.tag)!= null&&stack.get(DataReg.tag).getIntOr(hurt_size,0)< 351){
                                    stack.get(DataReg.tag).putInt(hurt_size,stack.get(DataReg.tag).getIntOr(hurt_size,0)+1);
                                }
                                if (stack.get(DataReg.tag)!= null&&stack.get(DataReg.tag).getIntOr(hurt_size,0)== 350){
                    ...
                    for (int i = 0; i < stacksHandler.getSlots(); i++) {
                        ...
                        if (!stack.isEmpty()) {
                            if (stack.is(Items.medicinebox.get())) {
                                ...
                                if (stack.get(DataReg.tag)!= null&&stack.get(DataReg.tag).getIntOr(jump_size,0)< 501){
                                    stack.get(DataReg.tag).putInt(jump_size,stack.get(DataReg.tag).getIntOr(jump_size,0)+1);

                                }
                                if (stack.get(DataReg.tag)!= null&&stack.get(DataReg.tag).getIntOr(jump_size,0)== 500){
                        ...
                        if (!stack.isEmpty()) {
                            if (stack.is(Items.medicinebox.get())) {
                                ...
                                if (a.is(net.minecraft.world.item.Items.ENCHANTED_GOLDEN_APPLE)) {
                                    ...
                                    if (stack.get(DataReg.tag) != null && !stack.get(DataReg.tag).getBooleanOr(enchant,false)) {
