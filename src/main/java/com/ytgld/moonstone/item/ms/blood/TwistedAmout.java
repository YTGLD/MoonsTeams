                                    ...
                                    if (stack.get(DataReg.tag)!=null){
                                        ...
                                        if (Mth.nextInt(RandomSource.create(),1,2)==1) {
                                            if (stack.get(DataReg.tag).getIntOr(MaxSword,0)<9) {
                                                ...
                                                stack.get(DataReg.tag).putInt(MaxSword, stack.get(DataReg.tag).getIntOr(MaxSword,0) + 1);
                                        ...
                                        if (stack.get(DataReg.tag).getIntOr(MaxSword,0)>=8){
    ...
    public void curioTickUse(SlotContext slotContext, ItemStack stack) {
        ...
        if (stack.get(DataReg.tag)!=null) {
            if (slotContext.entity().tickCount % 120 == 0) {
                if (stack.get(DataReg.tag).getIntOr(MaxSword, 0) > 0) {
                    stack.get(DataReg.tag).putInt(MaxSword, stack.get(DataReg.tag).getIntOr(MaxSword, 0) - 1);
