...
public class FoolBetray extends NightmareSmall {

    public FoolBetray(Properties properties) {
        super(properties);
    }
            ...
            if (SIHandler.hascurio(slotContext.entity(), this)) {
                if (!player.getCooldowns().isOnCooldown(this.getDefaultInstance().getItem())) {
                    ...
                    for (Mob mob : entities) {
                        ...
                        player.getCooldowns().addCooldown(this.getDefaultInstance().getItem(), 100 + entities.size() * 100);
                    }
                }
            }
        }
