...
public class AdvancementEvt {
    public static void giveItem(Player player, ItemStack item) {
        ...
        AttributeModifier attributeModifier = new AttributeModifier(ResourceLocation.fromNamespaceAndPath(Moonstone.MODID, entity.getItem().getItem().getDescriptionId()), 1, AttributeModifier.Operation.ADD_VALUE);
