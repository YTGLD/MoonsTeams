...
public abstract class AbstractZombieRenderer<T extends CellZombie, M extends ZombieModel<T>> extends HumanoidMobRenderer<T, M> {
    ...
    public ResourceLocation getTextureLocation(CellZombie p_113771_) {
