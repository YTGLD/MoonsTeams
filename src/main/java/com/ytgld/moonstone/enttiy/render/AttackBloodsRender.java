...
public class AttackBloodsRender extends EntityRenderer<@NotNull AttackBlood> {
    ...
    @Override
    public ResourceLocation getTextureLocation(@NotNull AttackBlood attackBlood) {
        return ResourceLocation.fromNamespaceAndPath(Moonstone.MODID, "");
    }

    @Override
    public void render(@NotNull AttackBlood p_entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        HandlerClient.showOutline = true;
        HandlerClient.doPass = true;

        AttackBlood entity = p_entity;
    ...
    private void setT(PoseStack matrices, AttackBlood entity, VertexConsumer vertexConsumers) {
