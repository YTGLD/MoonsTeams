...
public class EntityTs {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AttackBlood>> attack_blood_ = REGISTRY.register("attack_blood", () ->
            EntityType.Builder.of(AttackBlood::new, MobCategory.MISC).sized(0.01f, 0.01f).clientTrackingRange(50).build("attack_blood"));
    public static final DeferredHolder<EntityType<?>, EntityType<OwnerBlood>> owner_blood_ = REGISTRY.register("owner_blood", () ->
            EntityType.Builder.of(OwnerBlood::new, MobCategory.MISC).sized(0.01f, 0.01f).clientTrackingRange(50).build("owner_blood"));
    public static final DeferredHolder<EntityType<?>, EntityType<CellZombie>> cell_zombie = REGISTRY.register("cell_zombie", () ->
            EntityType.Builder.of(CellZombie::new, MobCategory.MISC).sized(0.8f, 1.8f).clientTrackingRange(50).build("cell_zombie"));
    public static final DeferredHolder<EntityType<?>, EntityType<CellGiant>> cell_giant = REGISTRY.register("cell_giant", () ->
            EntityType.Builder.of(CellGiant::new, MobCategory.MISC).sized(1.25f, 2.2f).clientTrackingRange(50).build("cell_giant"));

    public static final DeferredHolder<EntityType<?>, EntityType<AtSword>> at_sword_entity = REGISTRY.register("as_sword_entity", () ->
            EntityType.Builder.of(AtSword::new, MobCategory.MISC).sized(0.1f, 1.8f).clientTrackingRange(50).build("as_sword_entity"));
    public static final DeferredHolder<EntityType<?>, EntityType<SwordOfTwelve>> sword = REGISTRY.register("sword", () ->
            EntityType.Builder.of(SwordOfTwelve::new, MobCategory.MISC).sized(0.1f, 0.1f).clientTrackingRange(50).build("sword"));


    public static final DeferredHolder<EntityType<?>, EntityType<FlySword>> flysword = REGISTRY.register("flysword", () ->
            EntityType.Builder.of(FlySword::new, MobCategory.MISC).sized(0.1f, 0.1f).clientTrackingRange(50).build("flysword"));

    public static final DeferredHolder<EntityType<?>, EntityType<SmallSword>> as_sword = REGISTRY.register("as_sword", () ->
            EntityType.Builder.of(SmallSword::new, MobCategory.MISC).sized(0.1f, 0.1f).clientTrackingRange(50).build("as_sword"));
