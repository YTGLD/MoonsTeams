    ...
    public void registerRecipes(IRecipeRegistration registration) {
        {
            ...
            registration.addIngredientInfo(new ItemStack(Items.lead.get()), VanillaTypes.ITEM_STACK, Component.translatable("moonstone.jei.item.moonstone.lead").append(Component.translatable("moonstone.jei.item.moonstone.nightmare_base.all").append(Component.translatable("item.moonstone.nightmare_base"))));
